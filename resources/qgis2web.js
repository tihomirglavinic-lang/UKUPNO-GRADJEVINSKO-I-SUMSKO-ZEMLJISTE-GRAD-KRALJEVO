...
map.getView().fit([2295960.422429, 5411697.620420, 2308938.856043, 5419320.514697], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GEADJEVINSKO I SUMSKO ZEMLJISTE GRAD KRALJEVO</h2>';
        return titleElement;
    })(),
